...
public class Waypoint : MonoBehaviour
{
	...
	public void Click()
	{
		...
		Camera.main.transform.parent.transform.position = new Vector3 (gameObject.transform.position.x, Camera.main.transform.parent.transform.position.y, gameObject.transform.position.z);//gameObject.transform.position;
	}
